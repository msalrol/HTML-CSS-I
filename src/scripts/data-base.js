const imagenesBase = {
    barracaImg: new URL('../assets/images/discoteca-barraca-club-valencia-ruta-iberica.jpg', import.meta.url).href,
    amnesiaImg: new URL('../assets/images/discoteca-amnesia-ibiza.jpg', import.meta.url).href,
    razzmatazzImg: new URL('../assets/images/discoteca-razzmatazz-barcelona.jpg', import.meta.url).href,
    opiumImg: new URL('../assets/images/discoteca-opium-barcelona.jpg', import.meta.url).href,
    pachaImg: new URL('../assets/images/discoteca-pacha-ibiza.jpg', import.meta.url).href,
    moonImg: new URL('../assets/images/discoteca-sala-moon-madrid.jpg', import.meta.url).href,
    spookImg: new URL('../assets/images/evento-41-aniversario-spook.jpg', import.meta.url).href,
    apoloImg: new URL('../assets/images/evento-six-sex-apolo.jpg', import.meta.url).href,
    ibizaImg: new URL('../assets/images/evento-pikes-presents-halloween-special-ibiza.jpg', import.meta.url).href,
    ovenImg: new URL('../assets/images/evento-total-halloween-en-oven.jpg', import.meta.url).href,
    awakeningsImg: new URL('../assets/images/festival-awakenings-barcelona.jpg', import.meta.url).href,
    monegrosImg: new URL('../assets/images/festival-monegros.jpg', import.meta.url).href,
    dreamBeachImg: new URL('../assets/images/festival-dreambeach.jpg', import.meta.url).href,
    medusaImg: new URL('../assets/images/festival-medusa.jpg', import.meta.url).href,
    sonarImg: new URL('../assets/images/festival-sonar.jpg', import.meta.url).href,
    DGTLImg: new URL('../assets/images/festival-dgtl-barcelona.jpg', import.meta.url).href
}
...
export const datosapp = {
    discotecas: [
        ...
        },
        {
            ...
            img: imagenesBase.razzmatazzImg,
            link: '/det3.html'
        },
        {
            nombre: 'Opium',
    ...
    festivales: [
        {
            ...
            img: imagenesBase.awakeningsImg
        },
        {
        ...
        },
        {
            ...
            img: imagenesBase.dreamBeachImg
        },
        {
            tipo: 'festival',
